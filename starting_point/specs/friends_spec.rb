...
class TestFriends < MiniTest::Test
  ...
  def test_likes_to_eat_returns_true
    result = likes_to_eat(@person2, "bread")
    assert_equal(true, result)
  end

  def test_likes_to_eat_returns_false
    result = likes_to_eat(@person3, "spinich")
  ...
  def test_remove_friend
    result = remove_friend(@person1, "Daphne")
  ...
  def test_loan_of_money
    result = loan_of_money(@person4, @person3, 20)
